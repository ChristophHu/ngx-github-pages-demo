...
export const NGX_GITHUB_PAGES_DEMO_INITIALIZER_PROVIDER: Provider = [
    provideAppInitializer(() => LoggerInitializer(inject(NGX_GITHUB_OPTIONS_TOKEN)))
]

export function LoggerInitializer(options: IGithubOptions): Promise<void> {
